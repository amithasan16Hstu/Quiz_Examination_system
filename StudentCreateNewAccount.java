...
public class StudentCreateNewAccount implements Initializable {
    ...
    void createbuttonOnAction(ActionEvent event) {
        ...
        if (!StudentFileHandling.readVerify(v)) {
            Notifications.create()
        ...
        StudentFileHandling.appenedFile("studentEmailPassword.txt", user, pass, phoneNum, gend, date);
